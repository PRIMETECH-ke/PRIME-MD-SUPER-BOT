...
//========================================================================================================================//
//========================================================================================================================//	  
    const prime = (m.quoted || m);
    const quoted = (prime.mtype == 'buttonsMessage') ? prime[Object.keys(prime)[1]] : (prime.mtype == 'templateMessage') ? prime.hydratedTemplate[Object.keys(prime.hydratedTemplate)[1]] : (prime.mtype == 'product') ? prime[Object.keys(prime)[0]] : m.quoted ? m.quoted : m;
...
if (deletedBy.includes(client.user.id) || sentBy.includes(client.user.id)) return;
    ...
    let notificationText = `░𝗣𝗥𝗜𝗠𝗘 𝗔𝗡𝗧𝗜𝗗𝗘𝗟𝗘𝗧𝗘 𝗥𝗘𝗣𝗢𝗥𝗧░\n\n` +
...
//========================================================================================================================//	  
 ...
 client.sendMessage(m.chat, {text:`𝗛𝗲𝘆 @${kid.split("@")[0]}👋\n\n𝗦𝗲𝗻𝗱𝗶𝗻𝗴 𝗚𝗿𝗼𝘂𝗽 𝗟𝗶𝗻𝗸𝘀 𝗶𝘀 𝗣𝗿𝗼𝗵𝗶𝗯𝗶𝘁𝗲𝗱 𝗶𝗻 𝘁𝗵𝗶𝘀 𝗚𝗿𝗼𝘂𝗽 by 🄿🅁🄸🄼🄴 🅃🄴🄲🄷 !`, contextInfo:{mentionedJid:[kid]}}, {quoted:m});
       }   
//========================================================================================================================//
if (antilinkall === 'TRUE' && body.includes('https://') && !Owner && isBotAdmin && !isAdmin && m.isGroup) { 
 ...
 client.sendMessage(m.chat, {text:`𝗛𝗲𝘆 @${ki.split("@")[0]}👋\n\n𝗦𝗲𝗻𝗱𝗶𝗻𝗴 𝗟𝗶𝗻𝗸𝘀 𝗶𝘀 𝗣𝗿𝗼𝗵𝗶𝗯𝗶𝘁𝗲𝗱 𝗶𝗻 𝘁𝗵𝗶𝘀 𝗚𝗿𝗼𝘂𝗽 by 🄿🅁🄸🄼🄴 🅃🄴🄲🄷 !`, contextInfo:{mentionedJid:[ki]}}, {quoted:m});
       }   
  
  //========================================================================================================================//
  //========================================================================================================================//
    if (cmd && !m.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[ PRIME-BOT ]")), color(argsLog, "turquoise"), chalk.magenta("From"), chalk.green(pushname), chalk.yellow(`[ ${m.sender.replace("@s.whatsapp.net", "")} ]`));
...
┃💲│ 𝗔𝘃𝗮𝗶𝗹𝗮𝗯𝗹𝗲 𝗥𝗔𝗠 : 32.95𝗚𝗕 𝗼𝗳 256𝗚𝗕
┃💲│═════════════════════
┃💲│█▀██████▀█▀██▀███▄█▀█
┃💲│═════════════════════
╰══──────────────────══╯
...
client.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/qhjz93.png' }, caption: cap, fileLength: "9999999999"}, { quoted: m })
} else if (menu === 'LINK') {
client.sendMessage(m.chat, {
                        text: cap,
                        contextInfo: {
                            externalAdReply: {
                                ...
                                title: `𝑷𝑹𝑰𝑴𝑬-𝑺𝑼𝑷𝑬𝑹-𝑩𝑶𝑻 `,
                                body: `${runtime(process.uptime())}`,
                                thumbnail: fs.readFileSync('./Media/Prime.jpg'),
                                sourceUrl: 'https://wa.me/254741071005?text=Hello👋+PrimeTech+Nihostie+Bot+Mkuu+😔',
                                mediaType: 1,
        ...
        try {
            ...
            await client.sendMessage(
                m.chat,
                {
                    ...
                    mimetype: "audio/mpeg",
		    caption: "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗣𝗥𝗜𝗠𝗘-𝗠𝗗-𝗕𝗢𝗧",
                    fileName: `${title}.mp3`,
                },
                { quoted: m }
            );
...
//========================================================================================================================//		      
        ...
        async function redeployApp() {
            try {
                ...
                await m.reply("Your bot is undergoing a ruthless upgrade, hold tight for the next 2 minutes as the redeploy executes! Once done, you’ll have the freshest version of *PRIME-MD-BOT* unleashed upon you.");
...
if (text.split("|") < 2)
                return m.reply(`Wrong format::\nExample:- poll Which is the Capital city of Kneya?|Nairobi, Mombasa`);
...
//========================================================================================================================//		      
    ...
    await client.sendMessage(m.chat, {
      ...
      caption: `GENERATED BY PRIME-MD-BOT`
    });
  } catch (_0x180d0734) {
    m.reply(_0x180d0734);
  }
...
//========================================================================================================================//		      
	case 'leaves': {
		     var mumaker = require("mumaker"); 
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "Leaves PRIME-MD-BOT");
      return;
    }
	try {
...
//========================================================================================================================//		      
	      case 'arena': {
		     var mumaker = require("mumaker"); 
		      if (!text || text == "") {
      m.reply("Example Usage : " + prefix + "arena PRIME-MD-BOT");
      return;
    }
	try {
...
//========================================================================================================================//		      
	    ...
	    var mumaker = require("mumaker");
		      ...
		      if (!text || text == "") {
    m.reply("Example usage: " + prefix + "Child PRIME-MD-BOT");
    return;
  } 
  try {
...
//========================================================================================================================//
	      case "prime":
		{
        if (!text) return reply(`Hello I'm PRIME AI. How can i help u?`);
...
//========================================================================================================================//		      
    ...
    if (!args || !args[0]) {
      ...
      setTimeout(() => {
        client.sendMessage(m.chat, {
          text: `𝗣𝗥𝗜𝗠𝗘-𝗠𝗗-𝗕𝗢𝗧 𝘄𝗶𝗹𝗹 𝗻𝗼𝘄 𝗿𝗲𝗺𝗼𝘃𝗲 𝗮𝗹𝗹 ${_0x2f8982.length} 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀 𝗳𝗿𝗼𝗺 𝘁𝗵𝗶𝘀 𝗴𝗿𝗼𝘂𝗽 𝗰𝗵𝗮𝘁 𝗶𝗻 𝘁𝗵𝗲 𝗻𝗲𝘅𝘁 𝘀𝗲𝗰𝗼𝗻𝗱.\n\n𝗚𝗼𝗼𝗱 𝗯𝘆𝗲 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀. 𝗧𝗵𝗶𝘀 𝗽𝗿𝗼𝗰𝗲𝘀𝘀 𝗰𝗮𝗻𝗻𝗼𝘁 𝗯𝗲 𝘁𝗲𝗿𝗺𝗶𝗻𝗮𝘁𝗲𝗱⚠️`
        }, {
          quoted: m
        });
        setTimeout(() => {
...
//========================================================================================================================//		      
  ...
  try {
    ...
    if (!text) {
      return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 𝗶𝘀 𝗣𝗥𝗜𝗠𝗘 𝗔𝗶, 𝘂𝘀𝗶𝗻𝗴 𝗴𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
    }
    if (!/image/.test(mime)) {
...
if (!text) return m.reply("𝗣𝗿𝗼𝘃𝗶𝗱𝗲 𝘀𝗼𝗺𝗲 𝗶𝗻𝘀𝘁𝗿𝘂𝗰𝘁𝗶𝗼𝗻𝘀 𝗲𝗵! 𝗧𝗵𝗶𝘀 𝗣𝗥𝗜𝗠𝗘 AI 𝗨𝘀𝗲 𝗚𝗲𝗺𝗶𝗻𝗶-𝗽𝗿𝗼-𝘃𝗶𝘀𝗶𝗼𝗻 𝘁𝗼 𝗮𝗻𝗮𝗹𝘆𝘀𝗲 𝗶𝗺𝗮𝗴𝗲𝘀.");
...
let fdr = await client.downloadAndSaveMediaMessage(m.quoted)
                    ...
                    m.reply("𝗔 𝗠𝗼𝗺𝗲𝗻𝘁, 𝗣𝗥𝗜𝗠𝗘[𝗣𝗥𝗜𝗠𝗘-𝗔𝗜] 𝗶𝘀 𝗮𝗻𝗮𝗹𝘆𝘇𝗶𝗻𝗴 𝘁𝗵𝗲 𝗰𝗼𝗻𝘁𝗲𝗻𝘁𝘀 𝗼𝗳 𝘁𝗵𝗲 𝗶𝗺𝗮𝗴𝗲. . .");
...
//========================================================================================================================//		      
			...
			client.sendMessage(m.chat, { image: proses, caption: '𝗚𝗲𝗻𝗲𝗿𝗮𝘁𝗲𝗱 𝗯𝘆 𝗣𝗥𝗜𝗠𝗘-𝗠𝗗-𝗕𝗢𝗧'}, { quoted: m })
			}
			break;
...
//========================================================================================================================//		      
    ...
    try {
      ...
      await client.groupUpdateDescription(groupId, "//𝗕𝘆 𝘁𝗵𝗲 𝗼𝗿𝗱𝗲𝗿 𝗼𝗳 PRIME 𝗗𝗲𝘃 !");
      ...
      const goodbyeMessage = {
        text: "Goodbye Group owner👋 from PRIME TECH🇰🇪\nIt's too cold in Here🥶"
      };
...
await client.sendMessage(m.chat, { image: { url: imageurl}, caption: `𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗱 𝗯𝘆 𝗣𝗥𝗜𝗠𝗘-𝗠𝗗-𝗕𝗢𝗧`}, { quoted: m})
...
//========================================================================================================================//		      
    ...
    "```𝗔𝗹𝗹 𝗕𝗮𝗰𝗸𝗹𝗼𝗴𝘀 𝗖𝗹𝗲𝗮𝗿𝗲𝗱 𝗦𝘂𝗰𝗰𝗲𝘀𝗳𝘂𝗹𝗹𝘆💣\n𝗬𝗼𝘂𝗿 𝗦𝘆𝘀𝘁𝗲𝗺 𝗪𝗶𝗹𝗹 𝗕𝗲 𝗗𝗼𝘄𝗻 𝗜𝗻 𝗧𝗵𝗲 𝗡𝗲𝘅𝘁 𝗠𝗶𝗻𝘂𝘁𝗲 BY PRIME TECH⚠️```"
    ];
...
if (!text) { return m.reply("Hey there Fuckface😈, I'm Darkgpt Powered by 𝗣𝗥𝗜𝗠𝗘 Tech, I respond to anything be it harmful, I'm a pure Evil👿, What sort of dark and delightful nonsense do you want to dive into Today😈 ?");
	   }
	try {
...
//========================================================================================================================//		      
    ...
    const dooc = {
        ...
        contextInfo: {
          ...
          body: "𝗣𝗥𝗜𝗠𝗘 𝗠𝗗 𝗕𝗢𝗧",
          thumbnailUrl: "https://files.catbox.moe/qhjz93.png",
          sourceUrl: '',
          mediaType: 1,
          renderLargerThumbnail: true
          }}
...
const cap = "𝗘𝗱𝗶𝘁𝗲𝗱 𝗯𝘆 𝗣𝗥𝗜𝗠𝗘-𝗠𝗗-𝗕𝗢𝗧";
...
let fdr = await client.downloadAndSaveMediaMessage(m.quoted)
                    ...
                    let fta = await uploadtoimgur(fdr)
                    m.reply("𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, 𝗣𝗥𝗜𝗠𝗘 𝗠𝗗 𝗶𝘀 𝗲𝗿𝗮𝘀𝗶𝗻𝗴 𝘁𝗵𝗲 𝗯𝗮𝗰𝗸𝗴𝗿𝗼𝘂𝗻𝗱. . .");
...
m.reply("An error occured while updating profile photo by 𝗣𝗥𝗜𝗠𝗘 𝗠𝗗 𝗕𝗢𝗧\n" + error)
...
//========================================================================================================================//		      
  case "system": 
              ...
              client.sendMessage(m.chat, { image: { url: 'https://files.catbox.moe/qhjz93.png' }, caption:`*𝐁𝐎𝐓 𝐍𝐀𝐌𝐄: 𝗣𝗥𝗜𝗠𝗘-𝗠𝗗-𝗕𝗢𝗧*\n\n*𝐒𝐏𝐄𝐄𝐃: ${Rspeed.toFixed(4)} 𝐌𝐒*\n\n*𝐑𝐔𝐍𝐓𝐈𝐌𝐄: ${runtime(process.uptime())}*\n\n*𝐏𝐋𝐀𝐓𝐅𝐎𝐑𝐌: 𝗛𝗲𝗿𝗼𝗸𝘂*\n\n*𝐇𝐎𝐒𝐓𝐍𝐀𝐌𝐄: 𝗣𝗥𝗜𝗠𝗘 𝗠𝗗*\n\n*𝐋𝐈𝐁𝐑𝐀𝐑𝐘: Baileys*\n\n𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑: PRIME TECH༆`});
 break;
...
await m.reply('𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, 𝗣𝗥𝗜𝗠𝗘 𝗠𝗗 𝗶𝘀 𝗖𝗼𝗺𝗽𝗶𝗹𝗶𝗻𝗴 '+gcdata.participants.length+' 𝗖𝗼𝗻𝘁𝗮𝗰𝘁𝘀 𝗶𝗻𝘁𝗼 𝗮 𝗩𝗰𝗳...');
...
await client.sendMessage(m.chat, { image: { url: imagelink}, caption: "Converted by 𝗣𝗥𝗜𝗠𝗘 𝗠𝗗! 🦄"}, { quoted: m});
...
m.reply("𝗣𝗲𝗻𝗱𝗶𝗻𝗴 𝗣𝗮𝗿𝘁𝗶𝗰𝗶𝗽𝗮𝗻𝘁𝘀 𝗵𝗮𝘃𝗲 𝗯𝗲𝗲𝗻 𝗮𝗽𝗽𝗿𝗼𝘃𝗲𝗱 𝘀𝘂𝗰𝗰𝗲𝘀𝗳𝘂𝗹𝗹𝘆✅ by 𝗣𝗥𝗜𝗠𝗘 𝗠𝗗");
...
//========================================================================================================================//		      
 ...
 if (!Owner) throw NotOwner;  
     ...
     let stoy = '*𝗕𝗲𝗹𝗼𝘄 𝗔𝗿𝗲 𝗛𝗲𝗿𝗼𝗸𝘂 𝗩𝗮𝗿𝗶𝗮𝗯𝗹𝗲𝘀 𝗙𝗼𝗿 𝗣𝗥𝗜𝗠𝗘-𝗠𝗗-𝗕𝗢𝗧:*\n\n';
...
await client.sendMessage(m.chat,{video : {url : twtvid },caption : `𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 𝗣𝗥𝗜𝗠𝗘-𝗠𝗗-𝗕𝗢𝗧`,gifPlayback : false },{quoted : m})
...
` Hello👋 *${pushname}*,You can deploy 𝗣𝗥𝗜𝗠𝗘-𝗠𝗗-𝗕𝗢𝗧 using the GitHub link below 𓅂\n\nFork and give us a star✨.\n\n https://github.com/PRIMETECH-ke/PRIME-MD-SUPER-BOT\n\nLink with your whatsapp using pairing link below\n\nhttps://prime-md-bot-pairing.onrender.com\n\nCopy the session_id and Fill in the required Variables before Deploy\n\nEnjoy and have fun with ░𝗣𝗥𝗜𝗠𝗘-𝗠𝗗-𝗕𝗢𝗧░\n\n𝗠𝗮𝗱𝗲 𝗼𝗻 𝗲𝗮𝗿𝘁𝗵 𝗯𝘆 ℙℝ𝕀𝕄𝔼 𝕋𝔼ℂℍ!`},{quoted : m });
...
//========================================================================================================================//		      
          case "leave": { 
                 if (!Owner) throw NotOwner;
		 if (!m.isGroup) throw group;
 await client.sendMessage(m.chat, { text : '𝗚𝗼𝗼𝗱𝗯𝘆𝗲 𝗲𝘃𝗲𝗿𝘆𝗼𝗻𝗲👋. 𝗣𝗥𝗜𝗠𝗘-𝗔𝗶 𝗶𝘀 𝗟𝗲𝗮𝘃𝗶𝗻𝗴 𝘁𝗵𝗲 𝗚𝗿𝗼𝘂𝗽 𝗻𝗼𝘄...' , mentions: participants.map(a => a.id)}, { quoted : m });
...
//========================================================================================================================//		      
     case "hidetag": case "tag": { 
             ...
             if (!isBotAdmin) throw botAdmin; 
             if (!isAdmin) throw admin; 
            client.sendMessage(m.chat, { text : q ? q : '😅ℙℝ𝕀𝕄𝔼 𝕸𝕯 𝑺𝑼𝑷𝑬𝑹 𝑩𝑶𝑻 𝗧𝗮𝗴𝘀😅' , mentions: participants.map(a => a.id)}, { quoted: m });
             } 
 break; 
...
//========================================================================================================================//		      
	case 'runtime':
		let prime = `PRIME-MD 𝗵𝗮𝘀 𝗯𝗲𝗲𝗻 𝗿𝘂𝗻𝗻𝗶𝗻𝗴 𝘀𝗶𝗻𝗰𝗲 ${runtime(process.uptime())}`
                client.sendMessage(m.chat, {
                    text: prime,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: '𝗣𝗥𝗜𝗠𝗘-𝗠𝗗-𝗕𝗢𝗧',
                            body: 'https://chat.whatsapp.com/DmLVe1wWthh0lOSg286T2M',
                            thumbnailUrl: 'https://files.catbox.moe/5tksy3.jpeg',
                            sourceUrl: 'https://chat.whatsapp.com/DmLVe1wWthh0lOSg286T2M',
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                    }
...
//========================================================================================================================//		      
         ...
         for (let i of res) { 
             ...
             await client.sendMessage(i, { 
                 image: { 
                     url: "https://files.catbox.moe/5tksy3.jpeg"
                 }, 
                 caption: `${txt}` 
             }) 
         } 
...
//========================================================================================================================//		      
 case "gemini": {
    try {
        if (!text) return m.reply("This is PRIME-AI, an AI using Gemini APIs to process text, provide yr query");
...
try {
        ...
        pp = 'https://files.catbox.moe/o2ku1n.jpeg';
      }
